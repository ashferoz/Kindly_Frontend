...
const RequestCard = (props) => {
  return (
    <>
      <div className="w-[350px] h-[250px] bg-[#0753d8] flex flex-col justify-between p-4 hover:scale-105 transition-transform duration-200 ease-in-out cursor-pointer">
