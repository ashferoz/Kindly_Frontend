    ...
    <div className="fixed inset-0 flex justify-center items-center bg-[#00000078] z-50 font-epilogue">
      <div className="bg-white w-[1000px] h-[600px] flex">
        <div className="w-2/5 h-full">
          <img className="object-cover w-full h-full" src="../src/assets/clothes.jpg" alt="" />
        </div>
        ...
        <div className="mx-8">
          ...
          <p className="bg-[#ffc0cc] w-auto inline-block mx-2 px-3 py-1 rounded-3xl">{props.urgency}</p>
          <p className="bg-[#ffc0cc] w-auto inline-block mx-2 px-3 py-1 rounded-3xl">{props.location}</p>
          <p className="bg-[#ffc0cc] w-auto inline-block mx-2 px-3 py-1 rounded-3xl">{props.category}</p>
          </div>
          <h3>Details:</h3>
          <p>{props.details}</p>
        </div>
