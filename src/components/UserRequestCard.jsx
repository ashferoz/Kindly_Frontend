...
const UserRequestCard = (props) => {
  ...
  return (
    <>
      <div
        className="w-[350px] h-auto bg-[#9dc3c2] flex flex-col justify-between p-4 font-epilogue text-[#352a1f]"
      >
  ...
  <div className="flex">
    ...
    <div className="flex-1  text-md ">{props.status}</div>
        ...
        <div className="flex flex-col justify-end">
          <button className="bg-[#77a6b6]  m-1 rounded-md" onClick={props.onClick}>Update</button>
          <button onClick={mutate} className="bg-[#6a994e]  m-1 rounded-md">Remove</button>
        </div>
      </div>
    </>
  );
